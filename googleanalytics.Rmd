...
```{r}
knitr::include_graphics(here::here("resources/images/plot_session_overall.png"))
```

### Case study specific

```{r}
knitr::include_graphics(here::here("resources/images/plot_session_bycasestudy.png"))
```
